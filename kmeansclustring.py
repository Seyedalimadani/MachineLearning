# -*- coding: utf-8 -*-
"""KMeansclustring.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1IkQBo_cIOJr4nYPswMBuH2zPlYLp3Iks
...
"""use the scale function to scale our data down. We want to convert the large values that are contained as features into a range between -1 and 1 to simplify calculations and make training easier and more accurate.
We also define the amount of clusters by creating a variable k and we define how many samples and features we have by getting the data set shape.
"""
...
"""Finally to train the model we will create a K Means classifier then pass that classifier to the function we created above to score and train it."""
